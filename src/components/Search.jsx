...
export default function Search({ setQuery }) {
    ...
    return(
        <div className="md:float-right w-[100%] text-white text-sm md:text-base p-3 pt-0 my-7 md:my-2">
            <form id="the-form" onSubmit={(e) => handleSubmit(e)} className="w-[100%] container hidden bg-red-600 bg-opacity-70 p-3 justify-end">
                <div className="m-1 mt-0 md:m-2">
                    <label htmlFor="date-query" className="block mt-2">Select date:</label>
                    <input type="date" name="date" id="date" className="m-2 text-red-600" max={today} />
                </div>
            ...
            <div onClick={toggleForm} id="search-icon" className="float-right text-red-600">
                <i>
